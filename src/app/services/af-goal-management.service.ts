...
//   constructor(
//       public afDatabase: AngularFirestore, userAccountService: UserService) {
//     super();
...
//     return
//     this.afDatabase.collection('goals').doc(id).snapshotChanges().pipe(
//         map(snap => ({id: snap.payload.id, ...snap.payload.data()} as
//         Goal)));
//   }

//   updateProgress(newProgress:
//                      Map<string, {id: string, date: Date, progress:
//                      number}>) {
