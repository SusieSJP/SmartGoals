...
export abstract class UserAccountService {
  ...
  abstract updateName(email: string, userName: string): void;
  abstract updatePhoto(email: string, photoUrl: string): void;
  abstract updatePwd(email: string, pwd: string): void;
